document.addEventListener('DOMContentLoaded', function() {
    ...
    const sectionsData = [
        ...
        { id: 'ej3', title: '3. Hábitos de Inversión', icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>` },
    ...
    <div class="instructions-box"><p><strong>Meta Transformacional:</strong> Formalizar tu relación financiera con la empresa y alinearla con tus metas de crecimiento.</p></div>
    <div class="space-y-10">
        <div class="bg-gray-50 p-6 rounded-lg border">
    ...
    <div class="instructions-box"><p><strong>Meta Transformacional:</strong> Autoevaluación honesta de tus decisiones de inversión pasadas para identificar patrones y puntos ciegos.</p></div>
    ...
    <div class="instructions-box"><p><strong>Meta Transformacional:</strong> Transformar el cálculo del FCL de una simple resta a un diagnóstico dinámico de tu capacidad real de inversión.</p></div>
    ...
    <div class="instructions-box"><p><strong>Meta Transformacional:</strong> Pasar de ideas a enfoque estratégico claro.</p></div>
    <div class="space-y-8">
    ...
    <div class="instructions-box">
        <p><strong>Objetivo:</strong> Consolidar todo el análisis en una sola vista estratégica para la toma de decisiones.</p>
    </div>
